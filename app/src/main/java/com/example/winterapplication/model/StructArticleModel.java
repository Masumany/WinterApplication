...
public class StructArticleModel {

    private static final String API_URL = "https://www.wanandroid.com/article/list/0/json?cid=60";
    ...
    public void fetchData(final StructArticleCallback callback) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        // 使用 Gson 将 JSON 字符串解析为 StructArticleNew 对象
                        StructArticleNew structArticleNew = gson.fromJson(result, StructArticleNew.class);
                        // 通知回调接口数据获取成功，并传递解析后的对象
                        callback.onSuccess(structArticleNew);
                    } catch (Exception e) {
    ...
    public interface StructArticleCallback {

        void onSuccess(StructArticleNew structArticleNew);
